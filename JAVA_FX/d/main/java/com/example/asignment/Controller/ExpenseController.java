...
public class ExpenseController {
    @FXML
    private MenuButton categoryMenuButton1;
    @FXML
...
private BarChart<String, Number> barChart;
    ...
    private void loadCategoriesIntoMenu() {
        ...
        categoryMenuButton1.getItems().clear();
        for (Category category : categories) {
            MenuItem menuItem = new MenuItem(category.getName());
            menuItem.setOnAction(event -> {
                categoryMenuButton1.setText(category.getName());
                categoryMenuButton1.setUserData(category.getId());
                System.out.println("Selected category: " + category.getName());
            });
            categoryMenuButton1.getItems().add(menuItem);
        }
    }
    ...
    private void handleAddButtonAction() {
        ...
        String category = categoryMenuButton1.getText();
        ...
        categoryMenuButton1.setText("Category");
        exportToFile();
    ...
    public void exportToFile() {
        String sysPath = System.getProperty("user.dir");
        String dataFile = sysPath.replace("/", "\\") + "\\src\\main\\java\\com\\example\\asignment\\Database\\expense.txt";
        try (PrintWriter writer = new PrintWriter(new FileWriter(dataFile))) {
            ...
            System.out.println("Expenses exported to " + dataFile);
        } catch (IOException e) {

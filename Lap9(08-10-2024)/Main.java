...
public class Main {
    public static void main(String[] args) {
        ...
        Customer updateCustomer = new Customer(1, "Hieu-2309", Gender.MALE, 14);
        cc.updateCustomer(updateCustomer);
        Account customerupdate = new Account(1, updateCustomer, 3700);
        ac.updateAccount(customerupdate);
        Invoice updatedInvoice = new Invoice(1, updateCustomer, 1000, LocalDate.of(2023, 10, 8));
        ic.updateInvoice(updatedInvoice);
